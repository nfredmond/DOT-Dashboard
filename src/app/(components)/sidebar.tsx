...
export function Sidebar({ setCurrentPage, currentPage }: SidebarProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { id: "scoring", label: "Project Scoring", icon: FileTextIcon, path: "/project-scoring" },
    { id: "reports", label: "Reports", icon: ClipboardListIcon, path: "/reports" },
    { id: "llm-assist", label: "LLM Assistant", icon: BrainIcon, path: "/llm-assistant" },
